...
Inoltre, il sistema deve consentire di filtrare la lista dei modelli di impianto per: tipo, prezzo e superficie consigliata. I modelli di impianto sono sempre ordinati per prezzo crescente.
...
Inoltre, il sistema deve consentire di filtrare la lista delle recensioni per: valutazione in stelle e data. Le recensioni sono sempre ordinate per data, dalla più recente alla meno recente.
