...
***Descrizione***
Questo componente si occupa della funzione di visualizzazione della presentazione dell'azienda, che comprende descrizione testuale e mappa che indica la posizione dell'azienda. La mappa è reperita da OpenStreetMap.
...
|Fornita|Mostra Pagina|Il componente costruisce e invia all'utente anonimo la pagina di presentazione|

***Interfacce interne***

|Tipo|Nome|Descrizione|
|---|---|---------------------|
|Richiesta|Service Reviews|Il componenente attende le service reviews fornite da "Gestione service reviews" in un certo formato|
...
***Descrizione***
Questo componente si occupa dell'intero proccesso di conferma dell'indirizzo email: generazione del codice di conferma, invio dell'email con il codice di conferma e verifica del codice di conferma inserito dall'Utente Anonimo.
...
|Fornita|Email|Il componenete fornisce alla "Gestione invio email" l'email contenente il codice di conferma da inviare|
...
|Richiesta|Esito Verifica|Il componente ottiene da Ardeeno DataLayer l'esito della richiesta di verifica precedentemente inviata.|
...
***Descrizione***
Questo componente si occupa dell'intero processo di recupero della password: generazione del codice di recupero, invio dell'email con il codice di recupero, verifica del codice di conferma inserito dall'utente anonimo e inserimento della nuova password.
...
|Tipo|Nome|Descrizione|
|---|---|---------------------|
|Fornita|Richiesta inserimento codice|Il componente fornisce al sistema DataLayer un nuovo codice di recupero -- legato ad una certa email -- da inserire nella base di dati. Si assume che l'inserimento non abbia errori (e che l'email sia associata a qualche account)|
|Fornita|Richiesta verifica codice|Il componente fornisce al sistema DataLayer il codice di recupero ottenuto dall'Utente Anonimo da verificare. |
|Richiesta|Esito Verifica|Il componente attende l'esito della verifica del codice di recupero. Se l'esito è positivo (codice esistente e non scaduto), il sistema fornisce al DataLayer la nuova password |
|Fornita|Richiesta modifica password|Il componente -- se l'esito della verifica è positivo -- fornisce al DataLayer la nuova password inserita dall'utente. Si assume che l'inserimento non abbia errori.|

***Interfacce interne***

|Tipo|Nome|Descrizione|
|---|---|---------------------|
|Fornita|Email|Il componente fornisce alla "Gestione invio email" l'email contenente il codice di recupero da inviare.|
...
***Descrizione***
Questo componente si occupa di tutto ciò che riguarda la registrazione da parte di un utente anonimo.
...
|Tipo|Nome|Descrizione|
|---|---|---------------------|
|Fornita|Richiesta inserimento account|Il componenente fornisce al sistema DataLayer una richiesta di inserimento del nuovo account, che comprende tutti quei dati immessi in fase di registrazione|
|Richiesta|Esito inserimento|Il componente attende dal sistema DataLayer l'esito dell'inserimento del nuovo account|

***Interfacce interne***

|Tipo|Nome|Descrizione|
|---|---|---------------------|
|Fornita|Email|Il componente fornisce a "Gestione invio email" l'email di avvenuta registrazione da inviare al nuovo cliente|
...
***Descrizione***
Questo componente si occupa della funzione di login e rappresenta in sintesi l'interfaccia utente per il componente "Autenticazione"
...
|Fornita|Esito Login|Il componente inoltra all'Utente Anonimo l'esito della richiesta di login ottenuta dal comp. "Autenticazione"|

***Interfacce interne***

|Tipo|Nome|Descrizione|
|---|---|---------------------|
|Richiesta|Richiesta Login|Il componente inoltra al comp. "Autenticazione" la richiesta di login ricevuta dall'utente anonimo|
...
***Descrizione***
Questo componente si occupa dell'autenticazione, interfacciandosi col sistema DataLayer. Inoltre è utilizzato dagli altri componenti per verificare lo stato di autenticazione.
...
|Fornita|Check Auth|Il componente fornisce agli altri componenti lo stato corrente dell'autenticazione, che comprende anche -- se il login ha avuto esito positivo-- id utente ed email|

***Interfacce relative ad Ardeeno DataLayer***

|Tipo|Nome|Descrizione|
|---|---|---------------------|
|Fornita|Richiesta Verifica Credenziali|Il componente fornisce al sistema DataLayer la richiesta di verifica delle credenziali, che comprende email e password|
|Richiesta|Esito Verifica|Il componente attende dal sistema DataLayer l'esito della verifica delle credenziali. L'esito è positivo se l'email è associata a un account esistente e non dimesso, e se la password è corretta|
...
***Descrizione***
Questo componente si occupa della gestione dell'account di un utente autenticato; ovvero permette a un Utente Autenticato di visualizzare e modificare i propri dati. Interagisce col comp. "Autenticazione". Inoltre, interagisce anche col comp. "Conferma email" nel caso in cui l'Utente modifichi la propria email.
...
|Richiesta|Richiesta modifica|Il componente attende dall'Utente Autenticato la richiesta di modifica del proprio account, che comprende come parametri il tipo di dato e il nuovo dato|
...
|Fornita|ID Ordine|Il componente fornisce l'ID dell'ordine correttamente concluso ai comp. "Gestione codice prod.review" (che genera un nuovo codice prod.review) ed "Gestione installazioni e manutenzioni" (che genera inserisce un nuovo intervento di installazione)|
|Richiesta|Codice prod.review|Il componenete attende da "Gestione codice prod.review" il codice generato|
...
***Descrizione***
Questo componente si occupa di inserire automaticamente le richieste di interventi di installazione (all'acquisto di un impianto) e di manutenzione (periodicamente).
...
|Richiesta|Impianti attivi|Il componente attende dal sistema DataLayer la lista deli impianti al momento attivi|
|Fornita|Richiesta inserimento interventi|Il componente fornisce al sistema DataLayer il nuovo intervento -- manutenzione o installazione -- da inserire, sulla base degli impianti attivi precedentemente ricevuti o sulla base dell'id ordine|
