...
I commit `co-authored` (che assegnano un certo `work-time` a più membri contemporaneamente) possono falsare i tempi totali per Deliverable. Questi sono stati utilizzati per lo più nel D1.

<!--
, per cui, si propone una seconda tabella:
...
|Enrico Cescato|25|
|Matteo Sottocornola|23|

Il lavoro è stato svolto in gruppo ed in maniera costante; il contributo di ogni membro è dipeso anche dal carico di lavoro degli altri corsi.